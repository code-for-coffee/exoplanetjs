...
exoplanetjs.PlanetTypesListModel = require('./models/PlanetTypesCollection.js');
exoplanetjs.getPlanetType = require('./helpers/getPlanetType');
module.exports = exoplanetjs;

},{"./helpers/getPlanetType":2,"./models/PlanetTypesListModel.js":3}],2:[function(require,module,exports){
'use strict'; //es5
...
function getPlanetType(mass) {
  ...
  for (var inc = 0; inc < planets.length; inc++) {
...
},{"../models/PlanetTypesListModel":3}],3:[function(require,module,exports){
'use strict';
